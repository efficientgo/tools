...
func TestMultiError_Error(t *testing.T) {
	...
	testutil.Equals(t, "4 errors: test1; test1; test2; test3", merrors.New(err, err, stderrors.New("test2"), nil, stderrors.New("test3")).Err().Error())
}
...
func TestMultiError_Is(t *testing.T) {
	...
	testutil.Assert(t, stderrors.Is(e, merrors.New(err).Err()))
	testutil.Assert(t, !stderrors.Is(e, &err))
	testutil.Assert(t, !stderrors.Is(err, customErr{}))
	...
	testutil.Assert(t, stderrors.Is(e2, merrors.New(err, customErr3{}).Err()))
	testutil.Assert(t, !stderrors.Is(e2, merrors.New(customErr3{}, err).Err()))
	...
	testutil.Assert(t, stderrors.Is(e4, merrors.New(err, exact).Err()))
